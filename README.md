...
| Name         | Description                                                   | Type           | Required |
|--------------|---------------------------------------------------------------|----------------|----------|
| profile_id   | ID of an existing DigiCert TLM profile to use for certificate | String         | Yes      |
...
- Error: API request failed (401 Unauthorized)
  ...
  - Ensure the DigiCert API key is valid and has required access.

- Error: Validation failed due to unknown attributes

  - Check the DigiCert API documentation for the correct certificate attributes.

- Error: Certificate issuance failed (400 Bad Request)

  - Ensure all required fields are correctly defined in main.tf.

For more details, refer to the [DigiCert API documentation](https://stage.one.digicert.com/mpki/docs/swagger-ui/index.html#/Inventory) or enable Terraform debugging:
  ```
